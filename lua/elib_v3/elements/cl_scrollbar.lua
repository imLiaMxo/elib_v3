...
function PANEL:Paint(w, h)
    ...
    Elib.DrawRoundedBox(w / 2, 0, 0, w, h, self.Colour)
end

vgui.Register("Elib.ScrollbarGrip", PANEL, "Panel")
...
function PANEL:Init()
    ...
    self.Scrollbar = vgui.Create("Elib.ScrollbarGrip", self)
...
function PANEL:Paint(w, h)
    Elib.DrawRoundedBox(w / 2, 0, 0, w, h, self.BackgroundCol)
end

vgui.Register("Elib.Scrollbar", PANEL, "Panel")